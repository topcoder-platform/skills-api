...
async function fullyUpdate (id, entity, auth) {
  ...
  return updateMetaData(instance, entity, auth, constants.API_ACTION.TaxonomyPutMetadata)
}
...
async function particallyUpdate (id, entity, auth) {
  ...
  return updateMetaData(instance, { ...instance.dataValues.metadata, ...entity }, auth, constants.API_ACTION.TaxonomyPatchMetadata)
}
...
async function remove (id, fields, auth) {
  ...
  return updateMetaData(instance, _.omit(instance.dataValues.metadata, fields), auth, constants.API_ACTION.TaxonomyDeleteMetadata)
}
